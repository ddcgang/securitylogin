...
public class VerificationCodeUtil {
    ...
    //转载 https://www.cnblogs.com/fps2tao/p/13381190.html
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        //自定义字体
        String fontName = "";
        String fontPath = (com.demo.securitylogin.util.VerificationCodeUtil.class.getClassLoader().getResource("") + "static/fonts/Algerian.ttf").replace("file:/", "");
